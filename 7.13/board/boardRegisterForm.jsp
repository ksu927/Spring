   ...
   <div class="container">
   	<form class="form-horizontal" name="boardRegisterForm">
   		...
   		<div class="form-group">
   			...
   			<div class="col-sm-3">
   				<input type="text" class="form-control" id="subject" name="subject" maxlength="20" placeholder="이름 입력"/>
   			</div>
   		</div>
   		<div class="form-group">
   		...
   		<div class="form-group">
   			<p align="center">
   				<button type="reset" class="btn btn-waring">
   					<span class="glyphicon glyphicon-erase"> 다시 입력</span>
   				</button>
   				<button type="submit" class="btn btn-success" onClick="fn_boardRegister();">
   					<span class="glyphicon glyphicon-edit"> 게시글 등록</span>
   				</button>
   			</p>
   		</div>
   	</form>
